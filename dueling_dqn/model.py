...
class simplenet(nn.Module):
    def __init__(self, num_actions, num_observation):
        ...
        self.linear1 = nn.Linear(num_observation, 2+num_observation*2)
        self.state_value_fc = nn.Linear(2+num_observation*2, 2+num_observation*2)
        self.action_fc = nn.Linear(2+num_observation*2, 2+num_observation*2)
        self.action_value = nn.Linear(2+num_observation*2, num_actions)
        self.state_value = nn.Linear(2+num_observation*2, 1)
